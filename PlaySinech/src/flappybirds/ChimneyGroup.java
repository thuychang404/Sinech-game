...
public class ChimneyGroup {
    ...
    public ChimneyGroup() {
        try {
            ...
            chimneyImage = ImageIO.read(new File("Assets/deadline.jpg"));
            chimneyImage2 = ImageIO.read(new File("Assets/deadline.jpg"));
        ...
        for (int i = 0; i < SIZE / 2; i++) {
            ...
            cn = new Chimney(830 + i * 400, bottomChimneyY + deltaY, 74, 400);
            chimneys.push(cn);

            cn = new Chimney(830 + i * 400, topChimneyY + deltaY, 74, 400);
            chimneys.push(cn);
        }
    }
